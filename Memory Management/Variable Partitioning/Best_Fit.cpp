...
int main() {
    ...
    cout << "OUTPUT" << endl;
    cout << setw(8) << "File No" << setw(12) << "File Size" << setw(10) <<
        "Block No" << setw(12) << "Block Size" << setw(10) << "IFragment" << endl;
    ...
    for (int i = 0; i < files; i++) {
        ...
        if (bestFitBlockIndex != -1) {
            BlockSize[bestFitBlockIndex] -= FileSize[i];
            cout << setw(8) << i + 1 << setw(12) << FileSize[i] << setw(10) <<
                bestFitBlockIndex + 1 << setw(12) << BlockSize[bestFitBlockIndex] <<
                setw(10) << minFragment << endl;
            currAllot = true;
        }
        if (!currAllot) {
            cout << setw(8) << i + 1 << setw(12) << FileSize[i] << setw(10) << "--- -
    ...
    cout << "Total amount of Internal Fragmentation: " <<
        totalInternalFragmentation << endl;
    cout << "Total amount of External Fragmentation: " <<
